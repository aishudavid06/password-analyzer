...
def home():
    ...
    if request.method == "POST":
        ...
        if "❌" not in strength:
            ...
            if exists:
                strength = "⚠️ Password Already Used! Choose a new one"
            else:
    ...
    return render_template("index.html", strength=strength, suggestion=suggestion)
